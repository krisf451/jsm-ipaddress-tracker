    ...
    <>
      ...
      <div className="hidden lg:flex max-w-[1110px] w-[80%] h-[161px] mx-auto bg-white rounded-lg shadow-lg p-8 absolute bottom-[-80px] justify-between">
        <div className="w-full">
          ...
          <p className="text-[26px] font-[500]">{ipAddress}</p>
        </div>
